...
/* No fixed width/height — the SVG fills whatever the wrapper sizes it to,
   so the folders can shrink on narrow screens. */
export default function FolderIcon({ dark, light, sheen }: FolderPalette) {
  return (
    <svg viewBox="0 0 104 84" className="h-auto w-full" fill="none" aria-hidden>
